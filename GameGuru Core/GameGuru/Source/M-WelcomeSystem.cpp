...
void welcome_init ( int iLoadingPart )
{
	...
	if ( iLoadingPart == 0 )
	{
		...
		// more assets for welcome system
		welcome_loadasset(welcomePath, "welcome-assets\\registered-symbol.png", g.editorimagesoffset+65);
	}
...
void welcome_mainvr_page ( int iHighlightingButton )
{
	...
	welcome_drawrotatedimage(g.editorimagesoffset+65, 50.0f+36.0f, 10.0f-5.5f, 0, 0, 0, false);
